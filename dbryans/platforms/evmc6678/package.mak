...
package/%.xdc.inc package/%_evmc6678.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package evmc6678" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js evmc6678 $@
...
.PHONY: release,evmc6678
evmc6678.zip: package/package.bld.xml
evmc6678.zip: package/package.ext.xml
evmc6678.zip: package/package.rel.dot
evmc6678.zip: package/build.cfg
evmc6678.zip: package/package.xdc.inc
evmc6678.zip: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/evmc6678.zip.dep
endif
package/rel/evmc6678/evmc6678/package/package.rel.xml:

evmc6678.zip: package/rel/evmc6678.xdc.inc package/rel/evmc6678/evmc6678/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/evmc6678.xdc.inc,package/rel/evmc6678.zip.dep)


release release,evmc6678: all evmc6678.zip
clean:: .clean
	-$(RM) evmc6678.zip
	-$(RM) package/rel/evmc6678.xdc.inc
	-$(RM) package/rel/evmc6678.zip.dep
