...
/* Copyright (C) 2011
   ...
   - Replaced pthread APIs with gomp_thread abstract APIs 
   - Include omp.h instead of omp.h.in */
...
extern __FAR__ struct gomp_task_icv gomp_global_icv;
extern __FAR__ unsigned long gomp_thread_limit_var;
extern __FAR__ unsigned long gomp_remaining_threads_count;
#ifndef HAVE_SYNC_BUILTINS
extern gomp_mutex_t gomp_remaining_threads_lock;
#endif
extern __FAR__ unsigned long gomp_max_active_levels_var;
extern __FAR__ unsigned long long gomp_spin_count_var, gomp_throttled_spin_count_var;
extern __FAR__ unsigned long gomp_available_cpus, gomp_managed_threads;
...
#else
extern __FAR__ gomp_thread_key_t gomp_tls_key;
static inline struct gomp_thread *gomp_thread (void)
{
  return gomp_thread_getspecific (gomp_tls_key);
}
#endif
...
extern __FAR__ gomp_thread_attr_t gomp_thread_attr;

/* Other variables.  */

extern __FAR__ unsigned short *gomp_cpu_affinity;
extern __FAR__ size_t gomp_cpu_affinity_len;
...
extern void gomp_init_thread_affinity (gomp_thread_attr_t *);
...
#ifndef __GNUCS__
#define gomp_alloca(x) gomp_malloc(x);
#else
...
/* critical.c */
#ifndef __GNUCS__
extern void initialize_critical (void);
#endif
...
#endif /* LIBGOMP_H */
/*
 *  @(#) ti.omp; 0, 0, 1,71; 4-27-2011 17:02:32; /db/vtree/library/trees/omp/omp.git/src/ omp-a15
 */
