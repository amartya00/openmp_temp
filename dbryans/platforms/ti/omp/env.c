...
/* Copyright (C) 2011
   ...
   - Dummy 'getenv' function added
   - Casting added to suppress warning from TI compiler
   - Custom initialize_env added to initialize SYS/BIOS & IPC */
...
#pragma DATA_SECTION(gomp_cpu_affinity, "gomp_data")
#pragma DATA_SECTION(gomp_cpu_affinity_len, "gomp_data")
#pragma DATA_SECTION(gomp_global_icv, "gomp_data")
#pragma DATA_SECTION(gomp_max_active_levels_var, "gomp_data")
#pragma DATA_SECTION(gomp_thread_limit_var, "gomp_data")
#pragma DATA_SECTION(gomp_remaining_threads_count, "gomp_data")
#pragma DATA_SECTION(gomp_remaining_threads_lock, "gomp_data")
#pragma DATA_SECTION(gomp_available_cpus, "gomp_data")
#pragma DATA_SECTION(gomp_managed_threads, "gomp_data")
#pragma DATA_SECTION(gomp_spin_count_var, "gomp_data")
#pragma DATA_SECTION(gomp_throttled_spin_count_var, "gomp_data")
...
initialize_env (void)
{
  ...
  gomp_thread_attr_init (&gomp_thread_attr);
  gomp_thread_attr_setdetachstate (&gomp_thread_attr, GOMP_THREAD_CREATE_DETACHED);
  ...
  if (parse_stacksize ("OMP_STACKSIZE", &stacksize)
      || parse_stacksize ("GOMP_STACKSIZE", &stacksize))
    {
      ...
      err = gomp_thread_attr_setstacksize (&gomp_thread_attr, stacksize);
