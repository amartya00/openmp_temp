...
package/%.xdc.inc package/%_evmc6678sc.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package evmc6678sc" (because $@ is older than $(firstword $?))" ...
...
package/rel/undefinedevmc6678scpackage/package.rel.xml: package/package.cfg.xdc.inc
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	@$(MSG) generating schema include file list ...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js evmc6678sc $@
...
.PHONY: release,evmc6678sc
evmc6678sc.zip: package/package.bld.xml
evmc6678sc.zip: package/build.cfg
evmc6678sc.zip: package/package.xdc.inc
evmc6678sc.zip: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/evmc6678sc.zip.dep
endif
package/rel/evmc6678sc/evmc6678sc/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

evmc6678sc.zip: package/rel/evmc6678sc.xdc.inc package/rel/evmc6678sc/evmc6678sc/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/evmc6678sc.xdc.inc,package/rel/evmc6678sc.zip.dep)


release release,evmc6678sc: all evmc6678sc.zip
clean:: .clean
	-$(RM) evmc6678sc.zip
	-$(RM) package/rel/evmc6678sc.xdc.inc
	-$(RM) package/rel/evmc6678sc.zip.dep
