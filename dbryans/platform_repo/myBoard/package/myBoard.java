...
public class myBoard
{
    ...
    void Platform$$OBJECTS()
    {
        ...
        Object objP = om.bind("myBoard.Platform.Object", new Proto.Str(po, true));
    ...
    void Platform$$CREATES()
    {
        ...
        fxn = (Proto.Fxn)om.bind("myBoard.Platform$$create", new Proto.Fxn(om.findStrict("myBoard.Platform.Module", "myBoard"), om.findStrict("myBoard.Platform.Instance", "myBoard"), 3, 2, false));
        ...
        sb.append("myBoard$Platform$$create = function( name, args, __params ) {\n");
        ...
        fxn = (Proto.Fxn)om.bind("myBoard.Platform$$construct", new Proto.Fxn(om.findStrict("myBoard.Platform.Module", "myBoard"), null, 4, 2, false));
                fxn.addArg(0, "__obj", (Proto)om.findStrict("myBoard.Platform$$Object", "myBoard"), null);
                fxn.addArg(1, "name", $$T_Str, $$UNDEF);
                fxn.addArg(2, "args", $$T_Obj, $$UNDEF);
                fxn.addArg(3, "__params", (Proto)om.findStrict("myBoard.Platform.Params", "myBoard"), Global.newObject());
        sb = new StringBuilder();
        sb.append("myBoard$Platform$$construct = function( __obj, name, args, __params ) {\n");
            sb.append("var __mod = xdc.om['myBoard.Platform'];\n");
    ...
    void $$INITIALIZATION()
    {
        ...
        vo = (Value.Obj)om.findStrict("myBoard.Platform", "myBoard");
        Global.put(vo, "CPU", Global.callFxn("create", (Scriptable)om.find("ti.platforms.generic.Platform"), "CPU", Global.newObject("clockRate", 1000L, "catalogName", "ti.catalog.c6000", "deviceName", "TMS320C6678", "customMemoryMap", Global.newArray(new Object[]{Global.newArray(new Object[]{"MSMCSRAM", Global.newObject("name", "MSMCSRAM", "base", 0x0c000000L, "len", 0x00300000L, "space", "code/data", "access", "RWX")}), Global.newArray(new Object[]{"L1DSRAM", Global.newObject("name", "L1DSRAM", "base", 0x00F00000L, "len", 0x00004000L, "space", "data", "access", "RW")}), Global.newArray(new Object[]{"L1PSRAM", Global.newObject("name", "L1PSRAM", "base", 0x00E00000L, "len", 0x00004000L, "space", "code", "access", "RWX")}), Global.newArray(new Object[]{"L2SRAM", Global.newObject("name", "L2SRAM", "base", 0x00800000L, "len", 0x00080000L, "space", "code/data", "access", "RWX")}), Global.newArray(new Object[]{"MSMCSRAM_NOCACHE", Global.newObject("name", "MSMCSRAM_NOCACHE", "base", 0xa0300000L, "len", 0x00100000L, "space", "code/data", "access", "RWX")}), Global.newArray(new Object[]{"MSMCSRAM_CACHE", Global.newObject("name", "MSMCSRAM_CACHE", "base", 0x0c300000L, "len", 0x00100000L, "space", "code/data", "access", "RWX")}), Global.newArray(new Object[]{"DDR3", Global.newObject("name", "DDR3", "base", 0x80000000L, "len", 0x20000000L, "space", "code/data", "access", "RWX")})}), "l2Mode", "512k", "l1PMode", "32k", "l1DMode", "32k")));
