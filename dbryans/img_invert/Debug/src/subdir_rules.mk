...
src/img_invert.obj: ../src/img_invert.c $(GEN_OPTS) $(GEN_SRCS)
	@echo 'Building file: $<'
	@echo 'Invoking: C6000 Compiler'
	"C:/ti/bin/cl6x" -mv6600 --abi=eabi -g --include_path="C:/ti/include" --include_path="/opt/ti/xdctools_3_23_03_53/packages" --display_error_number --diag_warning=225 --preproc_with_compile --preproc_dependency="src/img_invert.pp" --obj_directory="src" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: $<'
	@echo ' '
