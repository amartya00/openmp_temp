...
.dlls,e66 .dlls: vector_stream.pe66

-include package/cfg/vector_stream_pe66.mak
-include package/cfg/vector_stream_pe66.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/vector_stream_pe66.dep
endif
vector_stream.pe66: package/cfg/vector_stream_pe66.xdl
	@


ifeq (,$(wildcard .libraries,e66))
vector_stream.pe66 package/cfg/vector_stream_pe66.c: .libraries,e66
endif

package/cfg/vector_stream_pe66.c package/cfg/vector_stream_pe66.h package/cfg/vector_stream_pe66.xdl: override _PROG_NAME := vector_stream.xe66
package/cfg/vector_stream_pe66.c: package/cfg/vector_stream_pe66.cfg

clean:: clean,e66
	-$(RM) package/cfg/vector_stream_pe66.cfg
	-$(RM) package/cfg/vector_stream_pe66.dep
	-$(RM) package/cfg/vector_stream_pe66.c
	-$(RM) package/cfg/vector_stream_pe66.xdc.inc

clean,e66::
	-$(RM) vector_stream.pe66
.executables,e66 .executables: vector_stream.xe66

vector_stream.xe66: |vector_stream.pe66

-include package/cfg/vector_stream.xe66.mak
vector_stream.xe66: package/cfg/vector_stream_pe66.oe66 
	$(RM) $@
	@$(MSG) lnke66 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C66.rootDir)/bin/lnk6x -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@)  -q -o $@ package/cfg/vector_stream_pe66.oe66   package/cfg/vector_stream_pe66.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C66.rootDir)/lib/rts6600_elf.lib
	
vector_stream.xe66: export C_DIR=
vector_stream.xe66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/:$(PATH)

vector_stream.test test,e66 test: vector_stream.xe66.test

vector_stream.xe66.test:: vector_stream.xe66
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 vector_stream.xe66.test
else
	@$(MSG) running $<  ...
	$(call EXEC.vector_stream.xe66, ) 
endif

clean,e66::
	-$(RM) .tmp,vector_stream.xe66,0,*


clean:: clean,e66

clean,e66::
	-$(RM) vector_stream.xe66
clean:: 
	-$(RM) package/cfg/vector_stream_pe66.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
vector_stream_pe66.oe66,copy : package/cfg/vector_stream_pe66.oe66
vector_stream_pe66.se66,copy : package/cfg/vector_stream_pe66.se66
