...
.dlls,e66 .dlls: img_conv_3x3.pe66

-include package/cfg/img_conv_3x3_pe66.mak
-include package/cfg/img_conv_3x3_pe66.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/img_conv_3x3_pe66.dep
endif
img_conv_3x3.pe66: package/cfg/img_conv_3x3_pe66.xdl
	@


ifeq (,$(wildcard .libraries,e66))
img_conv_3x3.pe66 package/cfg/img_conv_3x3_pe66.c: .libraries,e66
endif

package/cfg/img_conv_3x3_pe66.c package/cfg/img_conv_3x3_pe66.h package/cfg/img_conv_3x3_pe66.xdl: override _PROG_NAME := img_conv_3x3.xe66
package/cfg/img_conv_3x3_pe66.c: package/cfg/img_conv_3x3_pe66.cfg

clean:: clean,e66
	-$(RM) package/cfg/img_conv_3x3_pe66.cfg
	-$(RM) package/cfg/img_conv_3x3_pe66.dep
	-$(RM) package/cfg/img_conv_3x3_pe66.c
	-$(RM) package/cfg/img_conv_3x3_pe66.xdc.inc

clean,e66::
	-$(RM) img_conv_3x3.pe66
.executables,e66 .executables: img_conv_3x3.xe66

img_conv_3x3.xe66: |img_conv_3x3.pe66

-include package/cfg/img_conv_3x3.xe66.mak
img_conv_3x3.xe66: package/cfg/img_conv_3x3_pe66.oe66 
	$(RM) $@
	@$(MSG) lnke66 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C66.rootDir)/bin/lnk6x -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@)  -q -o $@ package/cfg/img_conv_3x3_pe66.oe66   package/cfg/img_conv_3x3_pe66.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C66.rootDir)/lib/rts6600_elf.lib
	
img_conv_3x3.xe66: export C_DIR=
img_conv_3x3.xe66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/:$(PATH)

img_conv_3x3.test test,e66 test: img_conv_3x3.xe66.test

img_conv_3x3.xe66.test:: img_conv_3x3.xe66
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 img_conv_3x3.xe66.test
else
	@$(MSG) running $<  ...
	$(call EXEC.img_conv_3x3.xe66, ) 
endif

clean,e66::
	-$(RM) .tmp,img_conv_3x3.xe66,0,*


clean:: clean,e66

clean,e66::
	-$(RM) img_conv_3x3.xe66
clean:: 
	-$(RM) package/cfg/img_conv_3x3_pe66.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
img_conv_3x3_pe66.oe66,copy : package/cfg/img_conv_3x3_pe66.oe66
img_conv_3x3_pe66.se66,copy : package/cfg/img_conv_3x3_pe66.se66
