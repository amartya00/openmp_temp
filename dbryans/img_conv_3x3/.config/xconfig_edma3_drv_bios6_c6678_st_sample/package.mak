...
override PKGDIR = xconfig_edma3_drv_bios6_c6678_st_sample
...
package/%.xdc.inc package/%_xconfig_edma3_drv_bios6_c6678_st_sample.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_edma3_drv_bios6_c6678_st_sample" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,e66 .dlls: edma3_drv_bios6_c6678_st_sample.pe66

-include package/cfg/edma3_drv_bios6_c6678_st_sample_pe66.mak
-include package/cfg/edma3_drv_bios6_c6678_st_sample_pe66.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/edma3_drv_bios6_c6678_st_sample_pe66.dep
endif
edma3_drv_bios6_c6678_st_sample.pe66: package/cfg/edma3_drv_bios6_c6678_st_sample_pe66.xdl
	@


ifeq (,$(wildcard .libraries,e66))
edma3_drv_bios6_c6678_st_sample.pe66 package/cfg/edma3_drv_bios6_c6678_st_sample_pe66.c: .libraries,e66
endif

package/cfg/edma3_drv_bios6_c6678_st_sample_pe66.c package/cfg/edma3_drv_bios6_c6678_st_sample_pe66.h package/cfg/edma3_drv_bios6_c6678_st_sample_pe66.xdl: override _PROG_NAME := edma3_drv_bios6_c6678_st_sample.xe66
package/cfg/edma3_drv_bios6_c6678_st_sample_pe66.c: package/cfg/edma3_drv_bios6_c6678_st_sample_pe66.cfg

clean:: clean,e66
	-$(RM) package/cfg/edma3_drv_bios6_c6678_st_sample_pe66.cfg
	-$(RM) package/cfg/edma3_drv_bios6_c6678_st_sample_pe66.dep
	-$(RM) package/cfg/edma3_drv_bios6_c6678_st_sample_pe66.c
	-$(RM) package/cfg/edma3_drv_bios6_c6678_st_sample_pe66.xdc.inc

clean,e66::
	-$(RM) edma3_drv_bios6_c6678_st_sample.pe66
.executables,e66 .executables: edma3_drv_bios6_c6678_st_sample.xe66

edma3_drv_bios6_c6678_st_sample.xe66: |edma3_drv_bios6_c6678_st_sample.pe66

-include package/cfg/edma3_drv_bios6_c6678_st_sample.xe66.mak
edma3_drv_bios6_c6678_st_sample.xe66: package/cfg/edma3_drv_bios6_c6678_st_sample_pe66.oe66 
	$(RM) $@
	@$(MSG) lnke66 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C66.rootDir)/bin/lnk6x -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@)  -q -o $@ package/cfg/edma3_drv_bios6_c6678_st_sample_pe66.oe66   package/cfg/edma3_drv_bios6_c6678_st_sample_pe66.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C66.rootDir)/lib/rts6600_elf.lib
	
edma3_drv_bios6_c6678_st_sample.xe66: export C_DIR=
edma3_drv_bios6_c6678_st_sample.xe66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/:$(PATH)

edma3_drv_bios6_c6678_st_sample.test test,e66 test: edma3_drv_bios6_c6678_st_sample.xe66.test

edma3_drv_bios6_c6678_st_sample.xe66.test:: edma3_drv_bios6_c6678_st_sample.xe66
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 edma3_drv_bios6_c6678_st_sample.xe66.test
else
	@$(MSG) running $<  ...
	$(call EXEC.edma3_drv_bios6_c6678_st_sample.xe66, ) 
endif

clean,e66::
	-$(RM) .tmp,edma3_drv_bios6_c6678_st_sample.xe66,0,*


clean:: clean,e66

clean,e66::
	-$(RM) edma3_drv_bios6_c6678_st_sample.xe66
clean:: 
	-$(RM) package/cfg/edma3_drv_bios6_c6678_st_sample_pe66.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
edma3_drv_bios6_c6678_st_sample_pe66.oe66,copy : package/cfg/edma3_drv_bios6_c6678_st_sample_pe66.oe66
edma3_drv_bios6_c6678_st_sample_pe66.se66,copy : package/cfg/edma3_drv_bios6_c6678_st_sample_pe66.se66

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_edma3_drv_bios6_c6678_st_sample
xconfig_edma3_drv_bios6_c6678_st_sample.tar: package/package.bld.xml
xconfig_edma3_drv_bios6_c6678_st_sample.tar: package/package.ext.xml
xconfig_edma3_drv_bios6_c6678_st_sample.tar: package/package.rel.dot
xconfig_edma3_drv_bios6_c6678_st_sample.tar: package/build.cfg
xconfig_edma3_drv_bios6_c6678_st_sample.tar: package/package.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_edma3_drv_bios6_c6678_st_sample.tar.dep
endif
package/rel/xconfig_edma3_drv_bios6_c6678_st_sample/xconfig_edma3_drv_bios6_c6678_st_sample/package/package.rel.xml:

xconfig_edma3_drv_bios6_c6678_st_sample.tar: package/rel/xconfig_edma3_drv_bios6_c6678_st_sample.xdc.inc package/rel/xconfig_edma3_drv_bios6_c6678_st_sample/xconfig_edma3_drv_bios6_c6678_st_sample/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_edma3_drv_bios6_c6678_st_sample.xdc.inc,package/rel/xconfig_edma3_drv_bios6_c6678_st_sample.tar.dep)


release release,xconfig_edma3_drv_bios6_c6678_st_sample: all xconfig_edma3_drv_bios6_c6678_st_sample.tar
clean:: .clean
	-$(RM) xconfig_edma3_drv_bios6_c6678_st_sample.tar
	-$(RM) package/rel/xconfig_edma3_drv_bios6_c6678_st_sample.xdc.inc
	-$(RM) package/rel/xconfig_edma3_drv_bios6_c6678_st_sample.tar.dep
...
include custom.mak
clean:: 
	-$(RM) package/xconfig_edma3_drv_bios6_c6678_st_sample.pjt
