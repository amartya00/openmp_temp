...
.dlls,e66 .dlls: vector_add.pe66

-include package/cfg/vector_add_pe66.mak
-include package/cfg/vector_add_pe66.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/vector_add_pe66.dep
endif
vector_add.pe66: package/cfg/vector_add_pe66.xdl
	@


ifeq (,$(wildcard .libraries,e66))
vector_add.pe66 package/cfg/vector_add_pe66.c: .libraries,e66
endif

package/cfg/vector_add_pe66.c package/cfg/vector_add_pe66.h package/cfg/vector_add_pe66.xdl: override _PROG_NAME := vector_add.xe66
package/cfg/vector_add_pe66.c: package/cfg/vector_add_pe66.cfg

clean:: clean,e66
	-$(RM) package/cfg/vector_add_pe66.cfg
	-$(RM) package/cfg/vector_add_pe66.dep
	-$(RM) package/cfg/vector_add_pe66.c
	-$(RM) package/cfg/vector_add_pe66.xdc.inc

clean,e66::
	-$(RM) vector_add.pe66
.executables,e66 .executables: vector_add.xe66

vector_add.xe66: |vector_add.pe66

-include package/cfg/vector_add.xe66.mak
vector_add.xe66: package/cfg/vector_add_pe66.oe66 
	$(RM) $@
	@$(MSG) lnke66 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C66.rootDir)/bin/lnk6x -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@)  -q -o $@ package/cfg/vector_add_pe66.oe66   package/cfg/vector_add_pe66.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C66.rootDir)/lib/rts6600_elf.lib
	
vector_add.xe66: export C_DIR=
vector_add.xe66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/:$(PATH)

vector_add.test test,e66 test: vector_add.xe66.test

vector_add.xe66.test:: vector_add.xe66
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 vector_add.xe66.test
else
	@$(MSG) running $<  ...
	$(call EXEC.vector_add.xe66, ) 
endif

clean,e66::
	-$(RM) .tmp,vector_add.xe66,0,*
...
clean,e66::
	-$(RM) vector_add.xe66
clean:: 
	-$(RM) package/cfg/vector_add_pe66.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
vector_add_pe66.oe66,copy : package/cfg/vector_add_pe66.oe66
vector_add_pe66.se66,copy : package/cfg/vector_add_pe66.se66
