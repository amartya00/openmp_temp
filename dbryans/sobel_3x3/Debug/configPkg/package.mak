...
.dlls,e66 .dlls: sobel.pe66

-include package/cfg/sobel_pe66.mak
-include package/cfg/sobel_pe66.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/sobel_pe66.dep
endif
sobel.pe66: package/cfg/sobel_pe66.xdl
	@


ifeq (,$(wildcard .libraries,e66))
sobel.pe66 package/cfg/sobel_pe66.c: .libraries,e66
endif

package/cfg/sobel_pe66.c package/cfg/sobel_pe66.h package/cfg/sobel_pe66.xdl: override _PROG_NAME := sobel.xe66
package/cfg/sobel_pe66.c: package/cfg/sobel_pe66.cfg

clean:: clean,e66
	-$(RM) package/cfg/sobel_pe66.cfg
	-$(RM) package/cfg/sobel_pe66.dep
	-$(RM) package/cfg/sobel_pe66.c
	-$(RM) package/cfg/sobel_pe66.xdc.inc

clean,e66::
	-$(RM) sobel.pe66
.executables,e66 .executables: sobel.xe66

sobel.xe66: |sobel.pe66

-include package/cfg/sobel.xe66.mak
sobel.xe66: package/cfg/sobel_pe66.oe66 
	$(RM) $@
	@$(MSG) lnke66 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C66.rootDir)/bin/lnk6x -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@)  -q -o $@ package/cfg/sobel_pe66.oe66   package/cfg/sobel_pe66.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C66.rootDir)/lib/rts6600_elf.lib
	
sobel.xe66: export C_DIR=
sobel.xe66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/:$(PATH)

sobel.test test,e66 test: sobel.xe66.test

sobel.xe66.test:: sobel.xe66
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 sobel.xe66.test
else
	@$(MSG) running $<  ...
	$(call EXEC.sobel.xe66, ) 
endif
...
clean,e66::
	-$(RM) sobel.xe66
clean:: 
	-$(RM) package/cfg/sobel_pe66.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
sobel_pe66.oe66,copy : package/cfg/sobel_pe66.oe66
sobel_pe66.se66,copy : package/cfg/sobel_pe66.se66
