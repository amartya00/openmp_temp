...
override PKGDIR = xconfig_bilinear
...
package/%.xdc.inc package/%_xconfig_bilinear.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_bilinear" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,e66 .dlls: bilinear.pe66

-include package/cfg/bilinear_pe66.mak
-include package/cfg/bilinear_pe66.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/bilinear_pe66.dep
endif
bilinear.pe66: package/cfg/bilinear_pe66.xdl
	@


ifeq (,$(wildcard .libraries,e66))
bilinear.pe66 package/cfg/bilinear_pe66.c: .libraries,e66
endif

package/cfg/bilinear_pe66.c package/cfg/bilinear_pe66.h package/cfg/bilinear_pe66.xdl: override _PROG_NAME := bilinear.xe66
package/cfg/bilinear_pe66.c: package/cfg/bilinear_pe66.cfg

clean:: clean,e66
	-$(RM) package/cfg/bilinear_pe66.cfg
	-$(RM) package/cfg/bilinear_pe66.dep
	-$(RM) package/cfg/bilinear_pe66.c
	-$(RM) package/cfg/bilinear_pe66.xdc.inc

clean,e66::
	-$(RM) bilinear.pe66
.executables,e66 .executables: bilinear.xe66

bilinear.xe66: |bilinear.pe66

-include package/cfg/bilinear.xe66.mak
bilinear.xe66: package/cfg/bilinear_pe66.oe66 
	$(RM) $@
	@$(MSG) lnke66 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C66.rootDir)/bin/lnk6x -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@)  -q -o $@ package/cfg/bilinear_pe66.oe66   package/cfg/bilinear_pe66.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C66.rootDir)/lib/rts6600_elf.lib
	
bilinear.xe66: export C_DIR=
bilinear.xe66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/:$(PATH)

bilinear.test test,e66 test: bilinear.xe66.test

bilinear.xe66.test:: bilinear.xe66
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 bilinear.xe66.test
else
	@$(MSG) running $<  ...
	$(call EXEC.bilinear.xe66, ) 
endif

clean,e66::
	-$(RM) .tmp,bilinear.xe66,0,*
...
clean,e66::
	-$(RM) bilinear.xe66
clean:: 
	-$(RM) package/cfg/bilinear_pe66.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
bilinear_pe66.oe66,copy : package/cfg/bilinear_pe66.oe66
bilinear_pe66.se66,copy : package/cfg/bilinear_pe66.se66

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_bilinear
xconfig_bilinear.tar: package/package.bld.xml
xconfig_bilinear.tar: package/package.ext.xml
xconfig_bilinear.tar: package/package.rel.dot
xconfig_bilinear.tar: package/build.cfg
xconfig_bilinear.tar: package/package.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_bilinear.tar.dep
endif
package/rel/xconfig_bilinear/xconfig_bilinear/package/package.rel.xml:

xconfig_bilinear.tar: package/rel/xconfig_bilinear.xdc.inc package/rel/xconfig_bilinear/xconfig_bilinear/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_bilinear.xdc.inc,package/rel/xconfig_bilinear.tar.dep)


release release,xconfig_bilinear: all xconfig_bilinear.tar
clean:: .clean
	-$(RM) xconfig_bilinear.tar
	-$(RM) package/rel/xconfig_bilinear.xdc.inc
	-$(RM) package/rel/xconfig_bilinear.tar.dep
...
include custom.mak
clean:: 
	-$(RM) package/xconfig_bilinear.pjt
