...
.dlls,e66 .dlls: blas3libMC.pe66

-include package/cfg/blas3libMC_pe66.mak
-include package/cfg/blas3libMC_pe66.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/blas3libMC_pe66.dep
endif
blas3libMC.pe66: package/cfg/blas3libMC_pe66.xdl
	@


ifeq (,$(wildcard .libraries,e66))
blas3libMC.pe66 package/cfg/blas3libMC_pe66.c: .libraries,e66
endif

package/cfg/blas3libMC_pe66.c package/cfg/blas3libMC_pe66.h package/cfg/blas3libMC_pe66.xdl: override _PROG_NAME := blas3libMC.xe66
package/cfg/blas3libMC_pe66.c: package/cfg/blas3libMC_pe66.cfg

clean:: clean,e66
	-$(RM) package/cfg/blas3libMC_pe66.cfg
	-$(RM) package/cfg/blas3libMC_pe66.dep
	-$(RM) package/cfg/blas3libMC_pe66.c
	-$(RM) package/cfg/blas3libMC_pe66.xdc.inc

clean,e66::
	-$(RM) blas3libMC.pe66
.executables,e66 .executables: blas3libMC.xe66

blas3libMC.xe66: |blas3libMC.pe66

-include package/cfg/blas3libMC.xe66.mak
blas3libMC.xe66: package/cfg/blas3libMC_pe66.oe66 
	$(RM) $@
	@$(MSG) lnke66 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C66.rootDir)/bin/lnk6x -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/blas3libMC_pe66.oe66   package/cfg/blas3libMC_pe66.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C66.rootDir)/lib/rts6600_elf.lib
	
blas3libMC.xe66: export C_DIR=
blas3libMC.xe66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/;$(PATH)
blas3libMC.xe66: Path:=$(ti.targets.elf.C66.rootDir)/bin/;$(PATH)

blas3libMC.test test,e66 test: blas3libMC.xe66.test

blas3libMC.xe66.test:: blas3libMC.xe66
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 blas3libMC.xe66.test
else
	@$(MSG) running $<  ...
	$(call EXEC.blas3libMC.xe66, ) 
endif

clean,e66::
	-$(RM) .tmp,blas3libMC.xe66,0,*
...
clean,e66::
	-$(RM) blas3libMC.xe66
clean:: 
	-$(RM) package/cfg/blas3libMC_pe66.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
blas3libMC_pe66.oe66,copy : package/cfg/blas3libMC_pe66.oe66
blas3libMC_pe66.se66,copy : package/cfg/blas3libMC_pe66.se66
