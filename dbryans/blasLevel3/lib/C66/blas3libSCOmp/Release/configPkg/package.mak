...
ti.targets.elf.C66.rootDir ?= C:/PROGRA~2/TEXASI~1/C6000C~1.0B2
...
.dlls,e66 .dlls: blas3libSC.pe66

-include package/cfg/blas3libSC_pe66.mak
-include package/cfg/blas3libSC_pe66.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/blas3libSC_pe66.dep
endif
blas3libSC.pe66: package/cfg/blas3libSC_pe66.xdl
	@


ifeq (,$(wildcard .libraries,e66))
blas3libSC.pe66 package/cfg/blas3libSC_pe66.c: .libraries,e66
endif

package/cfg/blas3libSC_pe66.c package/cfg/blas3libSC_pe66.h package/cfg/blas3libSC_pe66.xdl: override _PROG_NAME := blas3libSC.xe66
package/cfg/blas3libSC_pe66.c: package/cfg/blas3libSC_pe66.cfg

clean:: clean,e66
	-$(RM) package/cfg/blas3libSC_pe66.cfg
	-$(RM) package/cfg/blas3libSC_pe66.dep
	-$(RM) package/cfg/blas3libSC_pe66.c
	-$(RM) package/cfg/blas3libSC_pe66.xdc.inc

clean,e66::
	-$(RM) blas3libSC.pe66
.executables,e66 .executables: blas3libSC.xe66

blas3libSC.xe66: |blas3libSC.pe66

-include package/cfg/blas3libSC.xe66.mak
blas3libSC.xe66: package/cfg/blas3libSC_pe66.oe66 
	$(RM) $@
	@$(MSG) lnke66 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C66.rootDir)/bin/lnk6x -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/blas3libSC_pe66.oe66   package/cfg/blas3libSC_pe66.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C66.rootDir)/lib/rts6600_elf.lib
	
blas3libSC.xe66: export C_DIR=
blas3libSC.xe66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/;$(PATH)
blas3libSC.xe66: Path:=$(ti.targets.elf.C66.rootDir)/bin/;$(PATH)

blas3libSC.test test,e66 test: blas3libSC.xe66.test

blas3libSC.xe66.test:: blas3libSC.xe66
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 blas3libSC.xe66.test
else
	@$(MSG) running $<  ...
	$(call EXEC.blas3libSC.xe66, ) 
endif

clean,e66::
	-$(RM) .tmp,blas3libSC.xe66,0,*
...
clean,e66::
	-$(RM) blas3libSC.xe66
clean:: 
	-$(RM) package/cfg/blas3libSC_pe66.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
blas3libSC_pe66.oe66,copy : package/cfg/blas3libSC_pe66.oe66
blas3libSC_pe66.se66,copy : package/cfg/blas3libSC_pe66.se66
