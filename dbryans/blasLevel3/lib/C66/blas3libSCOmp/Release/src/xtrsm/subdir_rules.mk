...
src/xtrsm/ctrsmC66SC.obj: C:/ti/delivered/blasLevel3/src/singleCore/xtrsm/ctrsmC66SC.c $(GEN_OPTS) $(GEN_SRCS)
	...
	"C:/Program Files (x86)/Texas Instruments/C6000 Code Generation Tools 7.4.0B2/bin/cl6x" -mv6600 --abi=eabi -O2 --include_path="C:/Program Files (x86)/Texas Instruments/C6000 Code Generation Tools 7.4.0B2/include" --include_path="C:/ti/delivered/blasLevel3/lib/C66/blas3libSCOmp/../../../inc" --define=DMA_COPYA --define=DMA_COPYB --display_error_number --diag_warning=225 --openmp --preproc_with_compile --preproc_dependency="src/xtrsm/ctrsmC66SC.pp" --obj_directory="src/xtrsm" $(GEN_OPTS__FLAG) "$<"
